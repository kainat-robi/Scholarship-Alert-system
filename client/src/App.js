...
import ScholarshipAlerts from "./components/user/scholarshipalerts";
import DigitalTracking from "./components/user/DigitalTracking";
import Intercept from "./components/interceptor";
...
import DigitalTrackingForm from "./components/admin/PreviousApplicationDetails"
    ...
    <>
      <UserProvider>
        ...
        <Routes>
          ...
          <Route path="/scholarship_information"element={<Information />}></Route>
          <Route path="/contact" element={<Contact />}></Route>
          <Route path="/login" element={<Login />}></Route>
          <Route path="/register" element={<Register />}></Route>
          <Route path="/scholarships" element={<ScholarshipTypes />}></Route>
          <Route path="/ScholarshipAlerts" element={<ScholarshipAlerts/>}></Route>
          <Route path="/DigitalTracking" element={<DigitalTracking />}></Route>
          <Route path="/view-scholarships" element={<ViewUserScholarships />} ></Route>
          ...
          <Route path="/adminDashboard/studentDetails"element={<StudentDetails />}/>
          <Route path="/update-scholarship/:id" element={<UpdateScholarship />}></Route>
          <Route path="/digitalTracking" element={<DigitalTrackingForm />}></Route>

          <Route path="/viewScholarships" element={<ViewScholarships />}></Route>
        </Routes>
