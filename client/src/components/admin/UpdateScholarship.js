  ...
  const getSingleScholarship = async () => {
    try {
      const { data } = await axios.get(
        `http://localhost:8080/get-scholarship/${params.id}`
      );
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await axios.put(
        `http://localhost:8080/get-scholarships/${id}`,
        {
          scholarshipName,
          deadline,
          amount,
                    ...
                    <div className="   ">
                      <Col sm={12} md={12}>
                        ...
                        >
                          ...
                          <option key={1} value={"merit-based"}>
                            Merit
                          </option>
                          <option key={2} value={"minority-based"}>
                            Minority
                          </option>
                          <option key={3} value={"need-based"}>
                            Need based
                          </option>
                          <option key={4} value={"international"}>
                            International
                          </option>
